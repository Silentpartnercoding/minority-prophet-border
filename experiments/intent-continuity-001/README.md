...
from owner authority to an exact effect. The corpus covers context, caller, task,
tool arguments, destination, HTTP method/body, payment amount/recipient, resource,
relay-parent, freshness, revocation, and payment-verification failures. It does
**not** claim to have exercised a
